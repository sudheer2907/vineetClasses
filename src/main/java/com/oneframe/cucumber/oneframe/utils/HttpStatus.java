...
public enum HttpStatus {
    ...
    BAD_REQUEST(400, "Bad AlertsRequest"), UNAUTHORIZED(401, "Unauthorized"), PAYMENT_REQUIRED(402, "Payment Required"),
    ...
    REQUEST_TIMEOUT(408, "AlertsRequest Timeout"), CONFLICT(409, "Conflict"), GONE(410, "Gone"),
    ...
    REQUEST_URI_TOO_LONG(414, "AlertsRequest-URI Too Long"), UNSUPPORTED_MEDIA_TYPE(415, "Unsupported Media Type"),
    ...
    CONNECTION_TIMED_OUT(522, "Connection timed out"), PROXY_DECLINED_REQUEST(523, "Proxy Declined AlertsRequest"),
