...
public class JQuerySelectDropdownPage {
	...
	private WebElement QuerySelectDropdownText;
	...
	public void verifyJQuerySelectDropdownPage() {
		...
		String QuerySelectDropdownTextCheck = QuerySelectDropdownText.getText();
		if(QuerySelectDropdownTextCheck.equalsIgnoreCase("Drop Down with Search box"));
